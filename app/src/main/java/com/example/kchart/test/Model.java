...
public class Model {
    ...
    public static List<BarEntry> getBarEntries() {
        List<StockListBean.StockBean> rawData = getData();
        return getBarEntries(rawData, 0);
    }

    private static List<CandleEntry> getCandleEntries(List<StockListBean.StockBean> rawData,
        int startIndex) {
        ...
        for (int i = 0; i < rawData.size(); i++) {
            ...
            CandleEntry entry =
                new CandleEntry(startIndex + i, stock.getHigh(), stock.getLow(), stock.getOpen(),
                    stock.getClose());
            entries.add(entry);
        }
    ...
    private static List<BarEntry> getBarEntries(List<StockListBean.StockBean> rawData,
        int startIndex) {
        ...
        for (int i = 0; i < rawData.size(); i++) {
            ...
            BarEntry entry = new BarEntry(startIndex + i, stock.getVolume());
            entries.add(entry);
        }
